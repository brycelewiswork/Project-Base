...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "flex size-full flex-col overflow-hidden rounded-xl bg-surface-secondary p-1 text-label",
        className
      )}
      {...props}
    />
...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="flex h-9 items-center gap-2 border-b border-stroke-faint px-2.5">
      <IconSearch className="size-4 shrink-0 text-label-secondary" />
...
function CommandSeparator({
  ...
  return (
    <CommandPrimitive.Separator
      ...
      className={cn("-mx-1 h-px bg-stroke-faint", className)}
      {...props}
    />
  )
}
