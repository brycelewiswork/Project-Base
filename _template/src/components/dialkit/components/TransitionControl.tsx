import { type SpringConfig, type EasingConfig, type TransitionConfig, DialStore } from '../store/DialStore';
...
export function TransitionControl({ panelId, path, label, value, onChange, help }: TransitionControlProps) {
  ...
  return (
    <Folder
      ...
      help={help}
      defaultOpen={true}
      canReset={!DialStore.isDefaultValue(panelId, path)}
      onReset={() => DialStore.resetValue(panelId, path)}
    >
